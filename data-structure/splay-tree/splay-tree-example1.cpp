...
namespace SplayTree
{
    Data apply(Data p, Data2 q, int sz) { return p*q.first+q.second*sz; }
...
int main()
{
    ...
    while(Q--)
    {
        ...
        else if(t==2)
        {
            int l, r;
            cin >> l >> r; l++;
            SplayTree::update(l, r, true, Data2(1, 0), SplayTree::root);
        }
        else if(t==3)
        {
            int l, r, x, y;
            cin >> l >> r >> x >> y; l++;
            SplayTree::update(l, r, false, Data2(x, y), SplayTree::root);
        }
        else
        {
            int l, r;
            cin >> l >> r; l++;
            cout << SplayTree::query(l, r, SplayTree::root).sum.x << "\n";
        }
    }
}